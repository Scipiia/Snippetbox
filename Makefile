DB_URL=postgresql://root:secret@localhost:5432/snippetbox?sslmode=disable
...
proto:
	...
	--openapiv2_out=doc/swagger --openapiv2_opt=allow_merge=true,merge_file_name=snippetbox \
    proto/*.proto
